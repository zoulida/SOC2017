 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://jdkWS/", wsdlLocation = "http://localhost:8989/WS_Server/Webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://jdkWS/", "WebServiceImplService");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://jdkWS/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jdkWS/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
